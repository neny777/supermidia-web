...
const onSubmit = async (values, { resetForm }) => {
    ...
    if (isEditMode.value) {
        ...
        const modal = showModal('Editar Colaborador', 'Confirma a edição do colaborador?', async () => {
            try {
                state.isProcessing = true;
                        ...
                        <div class="card">
                            ...
                            <div v-else>
                                <Form
                                    ...
                                    :initial-values="state.colaborador"
                                ...
                                >
                                    ...
                                    <div class="card-body my-4">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="ctps" class="col-form-label col-lg-4">CTPS</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="ctps"
