...
const isEditMode = ref(!!route.params.servicoId);
...
const hasChanges = (newValues) => JSON.stringify(newValues) !== JSON.stringify(state.servico);
...
onMounted(async () => {
    ...
    try {
        ...
        const response = await axiosInstance.get(`/servicos/${route.params.servicoId}`);
        state.servico = {
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">
                                    <h5>{{ isEditMode ? 'Editar Serviço' : 'Novo Serviço' }}</h5>
                                </div>
                            </div>
