...
const onSubmit = async (values, { resetForm }) => {
    ...
    if (isEditMode.value) {
        ...
        const modal = showModal('Editar Cliente', 'Confirma a edição do cliente?', async () => {
            try {
                state.isProcessing = true;
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    <h5>
                                        {{ isEditMode ? 'Editar Cliente Pessoa Física' : 'Novo Cliente Pessoa Física' }}
                                    </h5>
                                </div>
                            </div>
                            <!--end::Header-->
                                ...
                                >
                                    ...
                                    <div class="card-body my-4">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6 px-5 d-none">
                                                <div class="row">
                                                    <label for="id" class="col-form-label col-lg-4">Id</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="id"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="nome" class="col-form-label col-lg-4">Nome</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="nome"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="telefone" class="col-form-label col-lg-4"
                                                        >Telefone</label
                                                    >
                                                    <div class="col-lg-8">
                                                        <Field
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="cep" class="col-form-label col-lg-4">CEP</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="cep"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="numero" class="col-form-label col-lg-4">Número</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="numero"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="logradouro" class="col-form-label col-lg-4"
                                                        >Logradouro</label
                                                    >
                                                    <div class="col-lg-8">
                                                        <Field
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="bairro" class="col-form-label col-lg-4">Bairro</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="bairro"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="municipio" class="col-form-label col-lg-4"
                                                        >Município</label
                                                    >
                                                    <div class="col-lg-8">
                                                        <Field
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="uf" class="col-form-label col-lg-4">Estado</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="uf"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="cpf" class="col-form-label col-lg-4">CPF</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="cpf"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="rg" class="col-form-label col-lg-4">RG</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="rg"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="sexo" class="col-form-label col-lg-4">Sexo</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="select"
                                                            id="sexo"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="nascimento" class="col-form-label col-lg-4"
                                                        >Nascimento</label
                                                    >
                                                    <div class="col-lg-8">
                                                        <Field
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="categoria" class="col-form-label col-lg-4"
                                                        >Categoria</label
                                                    >
                                                    <div class="col-lg-8">
                                                        <Field
                                    ...
                                    <div class="card-footer">
                                        <div class="row m-2">
                                            ...
                                            <div class="col-lg-6 text-center">
                                                <button class="btn btn-success button-medium m-2" type="submit">
