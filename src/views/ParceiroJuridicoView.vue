                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    <h5>
                                        {{
                                            isEditMode
                                                ? 'Editar Parceiro Pessoa Jurídica'
                                                : 'Novo Parceiro Pessoa Jurídica'
                                        }}
                                    </h5>
                                </div>
                            </div>
                                ...
                                >
                                    ...
                                    <div class="card-body my-4">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="cnpj" class="col-form-label col-lg-4">CNPJ</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="cnpj"
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="row">
                                                    <label for="ie" class="col-form-label col-lg-4">IE</label>
                                                    <div class="col-lg-8">
                                                        <Field
                                                            as="input"
                                                            id="ie"
