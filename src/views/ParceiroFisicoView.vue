...
const onSubmit = async (values, { resetForm }) => {
    ...
    if (isEditMode.value) {
        ...
        const modal = showModal('Editar Parceiro', 'Confirma a edição do parceiro?', async () => {
            try {
                state.isProcessing = true;
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    <h5>
                                        {{
                                            isEditMode ? 'Editar Parceiro Pessoa Física' : 'Novo Parceiro Pessoa Física'
                                        }}
                                    </h5>
                                </div>
                            </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row m-2">
                                            <div class="col-lg-6 text-center">
                                                <RouterLink to="/parceiros" class="nav-link"
